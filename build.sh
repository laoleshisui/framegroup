...
export glog_ROOT=$(pwd)/../glog/build/build_lib/lib/cmake/
export PREFIX_PATH=${glog_ROOT}/glog:${Libevent_ROOT}/libevent:\${PROTO_ROOT}/protobuf:${PROTO_ROOT}/absl:${PROTO_ROOT}/utf8_range:${AProto_ROOT}/aproto:${CORE_ROOT}/acore:${libtaskqueue_ROOT}/taskqueue
