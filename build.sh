...
export PREFIX_PATH=${Libevent_ROOT}/libevent:${PROTO_ROOT}/protobuf:${PROTO_ROOT}/absl:${PROTO_ROOT}/utf8_range:${AProto_ROOT}/Aproto:${CORE_ROOT}/acore:${libtaskqueue_ROOT}/libtaskqueue
