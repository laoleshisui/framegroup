...
public:
    ...
    virtual void OnState(uint64_t id, const std::string& type, const std::vector<std::string>& values){}
    virtual void OnProcess(uint64_t id, const std::string& type, const std::vector<std::string>& args){}
};
